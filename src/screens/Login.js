        ...
        <View style={LoginStyles.containerMain}>
            ...
            <View style={LoginStyles.containerMiddle}>
                <View style={LoginStyles.userIconView}>
                    <Image source={require('../../assets/images/logoClient.png')} style={LoginStyles.userIcon}/>
                </View>
                <Text style={LoginStyles.containerText}>
                    Login
                </Text>
                <Text style={LoginStyles.containerTextAlt}>
                    Email
                </Text>
            ...
            <View style={LoginStyles.containerFooter}>
                <Image source={require('../../assets/images/screenBottomIntro.png')} style={LoginStyles.screenBottomImage}/>
            </View>
        </View>
    );
}
