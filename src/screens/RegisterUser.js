  ...
  return (
    <View style={RegisterUserStyles.containerScreen}>
      ...
      <View style={RegisterUserStyles.containerMain}>
        ...
        <Text style={RegisterUserStyles.containerTextAlt}>Nome</Text>
        ...
        <Text style={RegisterUserStyles.containerTextAlt}>Sobrenome</Text>
        <SafeAreaView style={RegisterUserStyles.inputTextBox}>
          <TextInput
            style={RegisterUserStyles.textInput}
            outlineColor="#000"
        ...
        <Text style={RegisterUserStyles.containerTextAlt}>CPF</Text>
        <SafeAreaView style={RegisterUserStyles.inputTextBox}>
          <TextInput
            style={RegisterUserStyles.textInput}
            outlineColor="#000"
        ...
        <Text style={RegisterUserStyles.containerTextAlt}>Endereço</Text>
        <SafeAreaView style={RegisterUserStyles.inputTextBox}>
          <TextInput
            style={RegisterUserStyles.textInput}
            outlineColor="#000"
