  ...
  return (
    <View style={RegisterUserStyles.containerScreen}>
      ...
      <View style={RegisterUserStyles.containerMain}>
        ...
        <Text style={RegisterUserStyles.containerTextAlt}>Email</Text>
        ...
        <Text style={RegisterUserStyles.containerTextAlt}>Senha</Text>
        <SafeAreaView style={RegisterUserStyles.inputTextBox}>
          <TextInput
            style={RegisterUserStyles.textInput}
            outlineColor="#000"
        ...
        <Text style={RegisterUserStyles.containerTextAlt}>Confirmar senha</Text>
        <SafeAreaView style={RegisterUserStyles.inputTextBox}>
          <TextInput
            style={RegisterUserStyles.textInput}
            outlineColor="#000"
